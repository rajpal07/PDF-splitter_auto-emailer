...
export default function LoginPage() {
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            // Store the access token in sessionStorage for later use with Gmail API
            if (accessToken) {
    ...
    return (
        <div className="flex min-h-screen flex-col items-center justify-center bg-gray-900 text-white">
            <div className="w-full max-w-md rounded-xl bg-gray-800 p-8 shadow-2xl border border-gray-700/50">
                <h1 className="mb-2 text-3xl font-bold text-center bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">
                    Welcome Back
                </h1>
                <p className="mb-8 text-center text-gray-400">
                    Sign in to access your workflow
                </p>
